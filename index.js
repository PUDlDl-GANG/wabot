...
conn.sendMessage(id, '*🔥Tuh bro fitur / command yang ada di bot ini jika ada bug / yang tidak bisa mohon maaf ya sedang dalam pertahapan,  Thanks for use ITSMEIKY BOT🔥*' ,MessageType.text);
}
//else if (text == '.help'){
